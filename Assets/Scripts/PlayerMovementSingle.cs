...
public class PlayerMovementSingle : MonoBehaviour
{
    ...
    private PlayerInputControllerSingle ctrl;
    ...
    private void Awake()
    {
        ...
        ctrl = GetComponent<PlayerInputControllerSingle>();
    ...
    private void Start()
    {
        ...
        characters[DataManager.instance.GetP1Chara()-1].SetActive(true);
        ...
        else if(DataManager.instance.GetMode() == 2)
        {
            switch (gameObject.name)
            {
                case "P1":
                    ...
                    break;
                case "P2":
                    characters[DataManager.instance.GetP2Chara()-1].SetActive(true);
                    break;
