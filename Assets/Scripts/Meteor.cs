...
public class Meteor : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D coll)
    {
        ...
        else if (coll.gameObject.CompareTag("Player"))
        {
            ...
            {
                // 플레이어 체력감소 || 게임 오버
                GameManagerSingle.instance.GameOver(coll.gameObject);
            }
        }
        //else if (!coll.gameObject.CompareTag("Player"))
